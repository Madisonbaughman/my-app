    ...
    <>
      ...
      <div className="mt-10 lg:mt-20 mb-10 lg:mb-[100px]">
        <div className="custom-container !py-0 flex gap-6 lg:flex-nowrap flex-wrap justify-center lg:justify-start">
          {/* Card 1 */}
          <div className="bg-white w-full max-w-[364px] rounded-xl overflow-clip">
            ...
            <div className="p-4">
              ...
              <p className="font-['Cormorant_Infant'] font-normal leading-[150%]">
                ...
                fitness programs Life stage–specific training (postpartum
                recovery, osteoporosis, healthy aging)
              </p>
            </div>
          </div>
          ...
          <div className="bg-white w-full max-w-[364px] rounded-xl overflow-clip">
            <div className="">
              {card2Ready ? (
                <img
                  className=""
                  src={photo4}
                  alt="Rehabilitation & Hand Therapy"
                />
              ) : (
                <ImgSkeleton className="w-full max-w-md aspect-[4/3] m-2" />
              )}
            ...
            <div className="p-4">
              ...
              <p className="font-['Cormorant_Infant'] font-normal leading-[150%]">
                ...
                tendon/ligament injuries, nerve compressions, rotator cuff,
                fractures, CRPS
              </p>
            </div>
          </div>
          ...
          <div className="bg-white w-full max-w-[364px] rounded-xl overflow-clip">
            ...
            <div className="p-4">
              ...
              <p className="font-['Cormorant_Infant'] font-normal leading-[150%]">
                ...
                Preventive care programs for long-term joint and muscle health I
                also work holistically with other trusted practitioners to
                ensure clients receive comprehensive support. When needed, I
                connect clients with my network of recommended pelvic floor
                specialists, physical therapists, dietitians, and physicians —
                collaborating across disciplines to help you feel your best.
              </p>
            </div>
          </div>
        </div>
